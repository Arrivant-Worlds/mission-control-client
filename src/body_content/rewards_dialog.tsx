...
interface RewardDialogProps {
  ...
  rewards_dialog_data: RewardsDialogData | undefined;
  handleClaimJourneyReward: (reward_id: string, reward: RewardsDialogData) => Promise<{status: any; data: any;} | undefined>
  set_clicked_state: (state: boolean) => void;
  loadUserData: () => Promise<void>;
  handleRewardsClose: () => Promise<void>;
  rewards_dialog_state: boolean;
  clicked_state: boolean;
}
