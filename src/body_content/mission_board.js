  ...
  return (
    <Box style={styles.mission_board_container}>
      ...
      >
        ...
        <Box
          style={props.expanded_tab === "daily" ? styles.hr : styles.hidden}
        />
        <SimpleBar
          style={
            props.expanded_tab === "daily"
      ...
      >
        ...
        <Box
          style={props.expanded_tab === "weekly" ? styles.hr : styles.hidden}
        />
        <SimpleBar
          style={
            props.expanded_tab === "weekly"
      ...
      >
        ...
        >
          ...
          <Box
            component="img"
            src={props.expanded_tab === "prime" ? minus : plus}
            style={props.expanded_tab === "prime" ? styles.minus : styles.plus}
          />
        </Grid>
        <Box
          style={props.expanded_tab === "prime" ? styles.hr : styles.hidden}
        />
        <SimpleBar
          style={
            props.expanded_tab === "prime"
